      ...
      <div className="max-w-6xl mx-auto px-5 lg:px-8 grid lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <a
              href="https://github.com/abhiraj2189"
              target="_blank"
              rel="noreferrer"
              className="w-11 h-11 rounded-full border border-[#232b36] flex items-center justify-center text-[#e6edf3] hover:border-[#f5a623]/50 hover:text-[#f5a623] transition-colors"
            >
              <FaGithub />
            </a>
