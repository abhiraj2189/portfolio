...
export default function Contact() {
  return (
    <section
      id="contact"
      className="min-h-screen bg-[#050816] px-6 py-24"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="flex gap-6 mt-12">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-14 h-14 rounded-full bg-white/10 border border-cyan-500 flex items-center justify-center text-white text-2xl hover:bg-cyan-500 transition"
              >
                <FaGithub />
              </a>
          ...
          >
            ...
            <input
              ...
              className="w-full bg-[#111827] border border-gray-700 rounded-xl px-5 py-4 text-white outline-none focus:border-cyan-400"
            />
            ...
            <button
              type="submit"
              className="w-full py-4 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-bold text-lg hover:scale-[1.02] transition"
            >
              Send Message 🚀
            </button>
